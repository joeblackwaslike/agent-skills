...
sha256: "fde94fa81c900ce0fa60663e96ccf5216c58c2cc3c9fd2e08e6522a32ea92c49"
---
...
| --- | --- | --- | --- |
| Anaconda | Dev Container Spec Maintainers | `ghcr.io/devcontainers/features/anaconda:1` | `1.1.0` |
| AWS CLI | Dev Container Spec Maintainers | `ghcr.io/devcontainers/features/aws-cli:1` | `1.1.4` |
| Azure CLI | Dev Container Spec Maintainers | `ghcr.io/devcontainers/features/azure-cli:1` | `1.3.0` |
| Common Utilities | Dev Container Spec Maintainers | `ghcr.io/devcontainers/features/common-utils:2` | `2.6.0` |
...
| Docker (Docker-in-Docker) | Dev Container Spec Maintainers | `ghcr.io/devcontainers/features/docker-in-docker:4` | `4.1.1` |
| Docker (docker-outside-of-docker) | Dev Container Spec Maintainers | `ghcr.io/devcontainers/features/docker-outside-of-docker:1` | `1.10.1` |
...
| GitHub CLI | Dev Container Spec Maintainers | `ghcr.io/devcontainers/features/github-cli:1` | `1.1.2` |
...
| Java (via SDKMAN!) | Dev Container Spec Maintainers | `ghcr.io/devcontainers/features/java:1` | `1.8.3` |
| Kubectl, Helm, and Minikube | Dev Container Spec Maintainers | `ghcr.io/devcontainers/features/kubectl-helm-minikube:1` | `1.3.1` |
| Nix Package Manager | Dev Container Spec Maintainers | `ghcr.io/devcontainers/features/nix:1` | `1.4.0` |
...
| PowerShell | Dev Container Spec Maintainers | `ghcr.io/devcontainers/features/powershell:2` | `2.0.3` |
...
| Rust | Dev Container Spec Maintainers | `ghcr.io/devcontainers/features/rust:1` | `1.6.0` |
| SSH server | Dev Container Spec Maintainers | `ghcr.io/devcontainers/features/sshd:1` | `1.1.0` |
| Terraform, tflint, and TFGrunt | Dev Container Spec Maintainers | `ghcr.io/devcontainers/features/terraform:1` | `1.5.0` |
...
| Conda, Mamba (Miniforge) | Rocker Project | `ghcr.io/rocker-org/devcontainer-features/miniforge:2` | `2.0.2` |
| Pandoc | Rocker Project | `ghcr.io/rocker-org/devcontainer-features/pandoc:1` | `1.0.0` |
| Quarto CLI | Rocker Project | `ghcr.io/rocker-org/devcontainer-features/quarto-cli:1` | `1.1.5` |
...
| R history | Rocker Project | `ghcr.io/rocker-org/devcontainer-features/r-history:0` | `0.2.0` |
...
| Homebrew | Meaningful | `ghcr.io/meaningful-ooo/devcontainer-features/homebrew:2` | `2.0.5` |
...
| Beads CLI (bd) | eitsupi | `ghcr.io/eitsupi/devcontainer-features/beads-cli:1` | `1.0.0` |
...
| jj (Jujutsu) | eitsupi | `ghcr.io/eitsupi/devcontainer-features/jujutsu-cli:1` | `1.0.0` |
...
| Homebrew | Stuart Bell | `ghcr.io/stu-bell/devcontainer-features/homebrew:1` | `1.0.0` |
| Neovim (via AppImage) | Stuart Bell | `ghcr.io/stu-bell/devcontainer-features/neovim:0` | `0.1.2` |
| Node.js | Stuart Bell | `ghcr.io/stu-bell/devcontainer-features/node:0` | `0.5.2` |
| Open Code (via opencode.ai/install) | Stuart Bell | `ghcr.io/stu-bell/devcontainer-features/open-code:0` | `0.1.0` |
| Python | Stuart Bell | `ghcr.io/stu-bell/devcontainer-features/python:0` | `0.1.0` |
| ttyd | Stuart Bell | `ghcr.io/stu-bell/devcontainer-features/ttyd:0` | `0.1.0` |
...
| mitmproxy https proxy | Josh Spicer | `ghcr.io/joshspicer/features/mitm-proxy:1` | `1.1.0` |
...
| php | Shyim | `ghcr.io/shyim/devcontainers-features/php:0` | `0.1.5` |
...
| Chezmoi Dotfile Manager | rio | `ghcr.io/rio/features/chezmoi:1` | `1.1.1` |
| gum | rio | `ghcr.io/rio/features/gum:1` | `1.0.0` |
...
| Azure Functions Core Tools | jlaundry | `ghcr.io/jlaundry/devcontainer-features/azure-functions-core-tools:1` | `1.0.1` |
| SQL Server ODBC Driver | jlaundry | `ghcr.io/jlaundry/devcontainer-features/mssql-odbc-driver:1` | `1.0.3` |
...
| actionlint | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/actionlint:1` | `1.0.0` |
| ast-grep | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/ast-grep:1` | `1.0.0` |
...
| delta | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/delta:1` | `1.0.0` |
| Difftastic | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/difftastic:1` | `1.0.0` |
| fd | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/fd:1` | `1.0.0` |
| flux | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/flux:1` | `1.0.0` |
| fx | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/fx:1` | `1.0.0` |
| fzf | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/fzf:1` | `1.0.0` |
| gic | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/gic:1` | `1.0.0` |
| Git AI | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/gitai:1` | `1.0.0` |
| Gitleaks | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/gitleaks:1` | `1.0.0` |
| Glow | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/glow:1` | `1.0.0` |
| herdr | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/herdr:1` | `1.0.0` |
| hurl | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/hurl:1` | `1.0.0` |
| hyperfine | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/hyperfine:1` | `1.0.0` |
| jj | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/jj:1` | `1.0.0` |
| jnv | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/jnv:1` | `1.0.1` |
| just | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/just:1` | `1.0.0` |
...
| lazygit | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/lazygit:1` | `1.0.0` |
...
| rtk | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/rtk:1` | `1.0.0` |
...
| zizmor | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/zizmor:1` | `1.0.0` |
| zoxide | jsburckhardt | `ghcr.io/jsburckhardt/devcontainer-features/zoxide:1` | `1.0.0` |
...
| Microsoft SBOM-Tool | JasonTheDeveloper | `ghcr.io/jasonthedeveloper/features/sbom:1` | `1.1.1` |
| Trivy | JasonTheDeveloper | `ghcr.io/jasonthedeveloper/features/trivy:1` | `1.0.0` |
...
| Salesforce sf CLI | Jason Vercellone | `ghcr.io/vercellone/devcontainer-features/sf-cli:1` | `1.0.0` |
| Salesforce sfdx CLI | Jason Vercellone | `ghcr.io/vercellone/devcontainer-features/sfdx-cli:1` | `1.0.0` |
...
| Elm Language Compiler (via Github Releases) | Cody Taylor | `ghcr.io/codeman99/features/elm-lang:0` | `0.1.0` |
...
| Salesforce CLI (plugins) | jayree | `ghcr.io/jayree/devcontainer-features/sf-plugins:1` | `1.0.4` |
...
| Azure Developer CLI | Azure Developer CLI Team | `ghcr.io/azure/azure-dev/azd:0` | `0.2.0` |
| Azure Developer CLI - persistence | Azure Developer CLI Team | `ghcr.io/azure/azure-dev/azd-persistence:0` | `0.0.1` |
...
| PostgreSQL | John Chlark Sumatra | `ghcr.io/itsmechlark/features/postgresql:1` | `1.9.0` |
...
| Julia (via Juliaup) | Julia Language Community | `ghcr.io/julialang/devcontainer-features/julia:1` | `1.2.0` |
...
| Cypress | Ty Schlichenmeyer | `ghcr.io/schlich/devcontainer-features/cypress:1` | `1.0.2` |
...
| jujutsu | Ty Schlichenmeyer | `ghcr.io/schlich/devcontainer-features/jujutsu:0` | `0.1.0` |
| just | Ty Schlichenmeyer | `ghcr.io/schlich/devcontainer-features/just:0` | `0.1.0` |
...
| Playwright | Ty Schlichenmeyer | `ghcr.io/schlich/devcontainer-features/playwright:0` | `0.2.1` |
| PowerLevel10k | Ty Schlichenmeyer | `ghcr.io/schlich/devcontainer-features/powerlevel10k:1` | `1.0.0` |
| Rye | Ty Schlichenmeyer | `ghcr.io/schlich/devcontainer-features/rye:1` | `1.2.4` |
| Starship | Ty Schlichenmeyer | `ghcr.io/schlich/devcontainer-features/starship:0` | `0.1.6` |
...
| alpine-aws-cli | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-aws-cli:0` | `0.0.5` |
| alpine-bash | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-bash:0` | `0.0.3` |
| alpine-bat | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-bat:0` | `0.0.14` |
| alpine-bottom | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-bottom:0` | `0.0.7` |
| alpine-broot | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-broot:0` | `0.0.6` |
| alpine-bun | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-bun:0` | `0.0.2` |
| alpine-ctop | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-ctop:0` | `0.0.3` |
| alpine-curl | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-curl:0` | `0.0.2` |
| alpine-d2 | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-d2:0` | `0.0.2` |
| alpine-deno | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-deno:0` | `0.0.8` |
| alpine-docker-outside-of-docker | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-docker-outside-of-docker:0` | `0.0.23` |
| alpine-fswatch | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-fswatch:0` | `0.0.2` |
| alpine-gdb | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-gdb:0` | `0.0.2` |
| alpine-gh-cli | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-gh-cli:0` | `0.0.2` |
| alpine-git | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-git:0` | `0.0.2` |
| alpine-go | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-go:0` | `0.0.3` |
| alpine-gpg | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-gpg:0` | `0.0.2` |
| alpine-helm | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-helm:0` | `0.0.3` |
| alpine-jq | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-jq:0` | `0.0.2` |
| alpine-k3d | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-k3d:0` | `0.0.2` |
| alpine-kubectl | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-kubectl:0` | `0.0.3` |
| alpine-lazygit | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-lazygit:0` | `0.0.2` |
| alpine-mage2postman | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-mage2postman:0` | `0.0.3` |
| alpine-magento-cloud-cli | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-magento-cloud-cli:0` | `0.0.8` |
| alpine-make | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-make:0` | `0.0.2` |
| alpine-n98-magerun2 | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-n98-magerun2:0` | `0.0.33` |
| alpine-nano | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-nano:0` | `0.0.2` |
| alpine-navi | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-navi:0` | `0.0.12` |
...
| alpine-php-composer | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-php-composer:0` | `0.0.35` |
...
| alpine-php-ldap | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-php-ldap:0` | `0.0.2` |
| alpine-php-magento | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-php-magento:0` | `0.0.2` |
| alpine-php-mariadb | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-php-mariadb:0` | `0.0.2` |
| alpine-php-mssql | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-php-mssql:0` | `0.0.11` |
| alpine-php-mysql | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-php-mysql:0` | `0.0.2` |
| alpine-php-pcntl | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-php-pcntl:0` | `0.0.2` |
| alpine-php-pgsql | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-php-pgsql:0` | `0.0.2` |
| alpine-php-posix | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-php-posix:0` | `0.0.2` |
| alpine-php-redis | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-php-redis:0` | `0.0.2` |
| alpine-php-soap | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-php-soap:0` | `0.0.2` |
| alpine-php-sockets | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-php-sockets:0` | `0.0.4` |
| alpine-php-xdebug | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-php-xdebug:0` | `0.0.12` |
| alpine-php-zip | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-php-zip:0` | `0.0.2` |
| alpine-phpstorm-libs | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-phpstorm-libs:0` | `0.0.3` |
| alpine-ripgrep | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-ripgrep:0` | `0.0.2` |
| alpine-sentry-cli | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-sentry-cli:0` | `0.0.3` |
| alpine-sig | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-sig:0` | `0.0.2` |
| alpine-sshs | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-sshs:0` | `0.0.2` |
| alpine-starship | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-starship:0` | `0.0.3` |
| alpine-sudo | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-sudo:0` | `0.0.2` |
| alpine-user | cirolosapio | `ghcr.io/cirolosapio/devcontainers-features/alpine-user:0` | `0.0.4` |
...
| Radius CLI | radius-project | `ghcr.io/radius-project/devcontainer-features/radcli:0` | `0.1.0` |
...
| sshpass | Hans Spaans | `ghcr.io/hspaans/devcontainer-features/sshpass:1` | `1.0.3` |
...
| Bicep Langserver | kreemer | `ghcr.io/kreemer/features/bicep-langserver:1` | `1.0.0` |
...
| AWS CLI | Bart Venter | `ghcr.io/bartventer/arch-devcontainer-features/aws-cli:1` | `1.6.29` |
| Azure CLI | Bart Venter | `ghcr.io/bartventer/arch-devcontainer-features/azure-cli:1` | `1.0.22` |
| Common Utilities | Bart Venter | `ghcr.io/bartventer/arch-devcontainer-features/common-utils:1` | `1.4.134` |
| Docker (Docker-in-Docker) | Bart Venter | `ghcr.io/bartventer/arch-devcontainer-features/docker-in-docker:1` | `1.3.40` |
| Docker (docker-outside-of-docker) | Bart Venter | `ghcr.io/bartventer/arch-devcontainer-features/docker-outside-of-docker:1` | `1.3.40` |
| Google Cloud CLI | Bart Venter | `ghcr.io/bartventer/arch-devcontainer-features/gcloud-cli:1` | `1.0.77` |
...
| Infisical CLI | skriptfabrik | `ghcr.io/skriptfabrik/devcontainer-features/infisical-cli:1` | `1.1.2` |
...
| yamlfix (via pipx) | skriptfabrik | `ghcr.io/skriptfabrik/devcontainer-features/yamlfix:1` | `1.0.0` |
...
| Create Remote User | Nils Geistmann | `ghcr.io/nils-geistmann/devcontainers-features/create-remote-user:0` | `0.0.5` |
| exercism | Nils Geistmann | `ghcr.io/nils-geistmann/devcontainers-features/exercism:0` | `0.0.1` |
| zsh | Nils Geistmann | `ghcr.io/nils-geistmann/devcontainers-features/zsh:0` | `0.0.8` |
...
| Hashicorp direct install from mirror | weslyg | `ghcr.io/weslyg/features/hashicorp-mirror:2` | `2.0.2` |
...
| MATLAB | The MathWorks Inc. | `ghcr.io/mathworks/devcontainer-features/matlab:0` | `0.4.1` |
...
| PnP PowerShell | Julian Pawlowski | `ghcr.io/jpawlowski/devcontainer-features/pnp.powershell:1` | `1.0.1` |
| PowerShell Extended [PSResourceGet / NuGet Versioning; Oh My Posh prompt profile] | Julian Pawlowski | `ghcr.io/jpawlowski/devcontainer-features/powershell-extended:2` | `2.1.3` |
...
| uv | gvatsal60 (Vatsal Gupta) | `ghcr.io/gvatsal60/dev-container-features/uv:0` | `0.0.2` |
| Dokku Remote CLI | Codefabrik GmbH | `ghcr.io/code-fabrik/features/dokku-cli:1` | `1.0.0` |
| gdal | Codefabrik GmbH | `ghcr.io/code-fabrik/features/gdal:1` | `1.0.3` |
| lazydocker | Codefabrik GmbH | `ghcr.io/code-fabrik/features/lazydocker:1` | `1.0.3` |
| osm2pgsql | Codefabrik GmbH | `ghcr.io/code-fabrik/features/osm2pgsql:1` | `1.0.1` |
| pmtiles | Codefabrik GmbH | `ghcr.io/code-fabrik/features/pmtiles:1` | `1.0.1` |
| tippecanoe | Codefabrik GmbH | `ghcr.io/code-fabrik/features/tippecanoe:1` | `1.0.1` |
| Adobe Experience Manager LTS | Juan Ayala | `ghcr.io/juan-ayala/devcontainer-features/aem-lts:1` | `1.2.1` |
| Adobe Experience Manager Repo Tool | Juan Ayala | `ghcr.io/juan-ayala/devcontainer-features/aem-repo-tool:1` | `1.0.1` |
| Adobe Experience Manager SDK | Juan Ayala | `ghcr.io/juan-ayala/devcontainer-features/aem-sdk:1` | `1.2.3` |
...
| Add groups to container | AIT-Assistive-Autonomous-Systems maintainers | `ghcr.io/ait-assistive-autonomous-systems/devcontainer_features/add-groups:0` | `0.1.1` |
| Perl | Hauke D | `ghcr.io/haukex/devcontainer-features/perl:1` | `1.0.2` |
| Crystal Language | Caesarovich | `ghcr.io/caesarovich/devcontainer-feature-crystal/crystal:1` | `1.2.0` |
...
| age-keygen (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/age-keygen:1` | `1.0.17` |
...
| Ansible (via pipx) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/ansible:2` | `2.1.2` |
...
| archon (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/archon:1` | `1.0.0` |
| ArgoCD CLI (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/argo-cd:1` | `1.1.0` |
...
| bazel-compile-commands (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/bazel-compile-commands:1` | `1.0.0` |
...
| boilerplate (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/boilerplate:1` | `1.0.0` |
| bomber (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/bomber:1` | `1.0.10` |
| boundary (via asdf) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/boundary-asdf:2` | `2.0.16` |
...
| bottom (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/btm:1` | `1.0.17` |
...
| Bun | devcontainers-extra | `ghcr.io/devcontainers-extra/features/bun:1` | `1.1.0` |
| Bun package | devcontainers-extra | `ghcr.io/devcontainers-extra/features/bun-package:1` | `1.0.0` |
| Caddy (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/caddy:1` | `1.0.11` |
...
| claude-code | devcontainers-extra | `ghcr.io/devcontainers-extra/features/claude-code:2` | `2.0.3` |
...
| CodeBuddy Code (via npm) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/codebuddy-code:1` | `1.0.0` |
| Codefresh CLI (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/codefresh-cli:1` | `1.0.8` |
| codename-goose-cli | devcontainers-extra | `ghcr.io/devcontainers-extra/features/codename-goose-cli:1` | `1.0.0` |
...
| dart (via asdf) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/dart:1` | `1.0.0` |
...
| Deno (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/deno:1` | `1.0.4` |
...
| exa (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/exa:1` | `1.0.16` |
...
| eza (via GitHub Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/eza:1` | `1.0.0` |
...
| gofumpt (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/gofumpt:1` | `1.0.0` |
| golangci-lint (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/golangci-lint:1` | `1.0.0` |
...
| Heroku CLI (via cli-assets.heroku.com) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/heroku-cli:1` | `1.0.5` |
...
| infisical (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/infisical:1` | `1.0.0` |
...
| opencode (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/opencode:1` | `1.0.0` |
| opengrep (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/opengrep:1` | `1.0.0` |
| opentofu (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/opentofu:1` | `1.0.0` |
...
| OutageDeck CLI (via GitHub Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/outagedeck:1` | `1.0.0` |
...
| prek (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/prek:1` | `1.0.0` |
...
| Ruff (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/ruff:2` | `2.0.0` |
...
| shellcheck (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/shellcheck:1` | `1.1.0` |
...
| talosctl (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/talosctl:1` | `1.0.1` |
...
| Terragrunt (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/terragrunt:1` | `1.0.16` |
...
| ty (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/ty:1` | `1.0.0` |
...
| uv (via GitHub Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/uv:1` | `1.0.2` |
| Python tool (via uv) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/uv-tool:1` | `1.0.0` |
...
| worktrunk (via Github Releases) | devcontainers-extra | `ghcr.io/devcontainers-extra/features/worktrunk:1` | `1.0.0` |
...
| aqua-installer | Shunsuke Suzuki | `ghcr.io/aquaproj/devcontainer-features/aqua-installer:0` | `0.1.7` |
...
| Slang | loag | `ghcr.io/loag/slang-feature/slang:0` | `0.0.2` |
| Scalr CLI | zetta | `ghcr.io/zetta/devcontainer-features/scalr-cli:1` | `1.0.0` |
| Venom | zetta | `ghcr.io/zetta/devcontainer-features/venom:1` | `1.0.0` |
| Ubuntugis | Conner Shoop | `ghcr.io/connershoop/devcontainer-feature-ubuntugis/ubuntugis:1` | `1.0.1` |
...
| add-script | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/add-script:1` | `1.1.2` |
| alexpasmantier/television | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/alexpasmantier-television:1` | `1.0.3` |
| ankitpokhrel/jira-cli | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/ankitpokhrel-jira-cli:1` | `1.0.2` |
| apt-build-essential | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/apt-build-essential:1` | `1.0.2` |
| asdf-vm.com | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/asdf-vm.com:1` | `1.0.4` |
| astral.sh/uv | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/astral.sh-uv:1` | `1.0.6` |
| atuin.sh | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/atuin.sh:1` | `1.0.5` |
| avivsinai/bitbucket-cli | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/avivsinai-bitbucket-cli:1` | `1.0.2` |
| AWS CLI | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/aws-cli:1` | `1.1.4` |
| basecamp/fizzy-cli | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/basecamp-fizzy-cli:1` | `1.0.3` |
| bat | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/bat:1` | `1.0.3` |
| biomejs.dev | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/biomejs.dev:1` | `1.0.3` |
| btop | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/btop:1` | `1.0.5` |
| bun.sh | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/bun.sh:1` | `1.0.2` |
| ca-certificates | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/ca-certificates:1` | `1.0.0` |
| ccache.dev | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/ccache.dev:1` | `1.0.2` |
| charmbracelet/gum | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/charmbracelet-gum:1` | `1.0.6` |
| chezmoi.io | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/chezmoi.io:1` | `1.0.4` |
| clang-format | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/clang-format:1` | `1.0.2` |
| clang-tidy | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/clang-tidy:1` | `1.0.2` |
| cloudflare.com/warp-cli | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/cloudflare.com-warp-cli:1` | `1.0.3` |
| cmake.org | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/cmake.org:1` | `1.0.2` |
| coleam00/Archon | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/coleam00-Archon:1` | `1.0.0` |
| collection-c-cpp | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/collection-c-cpp:1` | `1.0.3` |
| critique.work | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/critique.work:1` | `1.0.2` |
| danmar/cppcheck | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/danmar-cppcheck:1` | `1.0.2` |
| delta | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/delta:1` | `1.0.3` |
| deno.com | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/deno.com:1` | `1.0.2` |
| devenv.sh | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/devenv.sh:1` | `1.0.2` |
| diffity.com | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/diffity.com:1` | `1.0.2` |
| direnv.net | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/direnv.net:1` | `1.0.2` |
| distcc.org | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/distcc.org:1` | `1.0.2` |
| dolthub.com | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/dolthub.com:1` | `1.0.2` |
| dolthub.com/doltgres | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/dolthub.com-doltgres:1` | `1.0.2` |
| dotenv.org | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/dotenv.org:1` | `1.0.2` |
| dozzle.dev | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/dozzle.dev:1` | `1.0.2` |
| fathyb/carbonyl | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/fathyb-carbonyl:1` | `1.0.2` |
| fd | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/fd:1` | `1.0.3` |
| feature-installer | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/feature-installer:1` | `1.0.2` |
| fzf | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/fzf:1` | `1.0.2` |
| getdnote.com | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/getdnote.com:1` | `1.0.2` |
| gitagent.sh | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/gitagent.sh:1` | `1.0.3` |
| github.com/cli | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/github.com-cli:1` | `1.0.3` |
| helix-editor.com | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/helix-editor.com:1` | `1.0.2` |
| hermes-agent.nousresearch.com | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/hermes-agent.nousresearch.com:1` | `1.0.2` |
| icholy/ttygif | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/icholy-ttygif:1` | `1.0.3` |
| jj-vcs.dev | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/jj-vcs.dev:1` | `1.0.4` |
| jnsahaj/lumen | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/jnsahaj-lumen:1` | `1.0.2` |
| joelhooks/agent-secrets | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/joelhooks-agent-secrets:1` | `1.0.3` |
| jonas/tig | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/jonas-tig:1` | `1.0.2` |
| jq | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/jq:1` | `1.0.2` |
| k9scli.io | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/k9scli.io:1` | `1.0.3` |
| keybase.io | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/keybase.io:1` | `1.2.2` |
| lazygit | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/lazygit:1` | `1.0.2` |
| lnav.org | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/lnav.org:1` | `1.0.2` |
| memvid.com | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/memvid.com:1` | `1.0.2` |
| mosh.org | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/mosh.org:1` | `1.0.2` |
| neovim.io | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/neovim.io:1` | `1.0.3` |
| ninja-build.org | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/ninja-build.org:1` | `1.0.2` |
| nixos.org | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/nixos.org:1` | `1.0.2` |
| nvidia.com/cuda | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/nvidia.com-cuda:1` | `1.0.2` |
| onecli.sh/cli | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/onecli.sh-cli:1` | `1.0.3` |
| opencode.ai | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/opencode.ai:1` | `1.0.7` |
| pi.dev | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/pi.dev:1` | `1.0.3` |
| pkgx.sh | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/pkgx.sh:1` | `1.0.2` |
| pulumi.com | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/pulumi.com:1` | `1.0.3` |
| rclone | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/rclone.org:1` | `1.0.3` |
| restic.net | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/restic.net:1` | `1.0.3` |
| ripgrep | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/ripgrep:1` | `1.0.3` |
| run-script | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/run-script:1` | `1.2.0` |
| schpet/linear-cli | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/schpet-linear-cli:1` | `1.0.4` |
| smallstep.com | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/smallstep.com:1` | `1.0.4` |
| socket.dev/sfw-free | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/socket.dev-sfw-free:1` | `1.0.2` |
| sourceware.org/gdb | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/sourceware.org-gdb:1` | `1.0.2` |
| sshd | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/sshd:1` | `1.0.2` |
| starship.rs | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/starship.rs:1` | `1.0.4` |
| steveyegge/beads | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/steveyegge-beads:1` | `1.0.2` |
| swc.rs | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/swc.rs:1` | `1.0.3` |
| sxyazi/yazi | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/sxyazi-yazi:1` | `1.0.2` |
| tailscale.com | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/tailscale.com:1` | `1.0.2` |
| taskwarrior.org | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/taskwarrior.org:1` | `1.0.2` |
| tree-sitter | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/tree-sitter:1` | `1.0.2` |
| turso.tech | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/turso.tech:1` | `1.0.2` |
| valgrind.org | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/valgrind.org:1` | `1.0.2` |
| vcpkg.io | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/vcpkg.io:1` | `1.0.2` |
| webinstall.dev | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/webinstall.dev:1` | `1.0.3` |
| yakitrak/notesmd-cli | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/yakitrak-notesmd-cli:1` | `1.0.2` |
| yoctoproject.org | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/yoctoproject.org:1` | `1.0.2` |
| yoctoproject.org/bitbake | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/yoctoproject.org-bitbake:1` | `1.0.2` |
| yq | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/yq:1` | `1.0.3` |
| zellij.dev | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/zellij.dev:1` | `1.0.4` |
| zyedidia/eget | devcontainer.community | `ghcr.io/devcontainer-community/devcontainer-features/zyedidia-eget:1` | `1.0.4` |
...
| Go Coverage with Badge | TheDiveO | `ghcr.io/thediveo/devcontainer-features/gocover:1` | `1.0.1` |
...
| Python Virtualenv | Jonathan Mills | `ghcr.io/itsalljustdata/devcontainers-custom-features/python-virtualenv:1` | `1.0.0` |
| kcat | irfansofyana | `ghcr.io/irfansofyana/devcontainer-features/kcat-apt:1` | `1.0.0` |
| lazydocker | irfansofyana | `ghcr.io/irfansofyana/devcontainer-features/lazydocker-binary-release:1` | `1.0.0` |
...
| code-server | Coder | `ghcr.io/coder/devcontainer-features/code-server:2` | `2.0.0` |
| mise-en-place | atty303 | `ghcr.io/atty303/devcontainer-features/mise:1` | `1.3.0` |
...
| AgentCore CLI | John Ajera | `ghcr.io/jajera/features/agentcore-cli:1` | `1.0.0` |
| Amazon Q CLI | John Ajera | `ghcr.io/jajera/features/amazon-q-cli:1` | `1.0.0` |
| AWS SAM CLI | John Ajera | `ghcr.io/jajera/features/aws-sam-cli:1` | `1.0.0` |
| Google Cloud CLI | John Ajera | `ghcr.io/jajera/features/gcloud-cli:1` | `1.0.1` |
| Zip Utility | John Ajera | `ghcr.io/jajera/features/zip:1` | `1.0.0` |
| Air | MrSimonEmms | `ghcr.io/mrsimonemms/devcontainers/air:1` | `1.0.0` |
| Buf CLI (via Github Releases) | MrSimonEmms | `ghcr.io/mrsimonemms/devcontainers/buf:1` | `1.0.1` |
| Butane | MrSimonEmms | `ghcr.io/mrsimonemms/devcontainers/butane:1` | `1.0.0` |
| Cobra CLI | MrSimonEmms | `ghcr.io/mrsimonemms/devcontainers/cobra-cli:1` | `1.0.0` |
| diff-so-fancy | MrSimonEmms | `ghcr.io/mrsimonemms/devcontainers/diff-so-fancy:1` | `1.0.0` |
| Dingo | MrSimonEmms | `ghcr.io/mrsimonemms/devcontainers/dingo:1` | `1.0.0` |
| Floci | MrSimonEmms | `ghcr.io/mrsimonemms/devcontainers/floci:1` | `1.0.0` |
| Temporal Cloud CLI (tcld) | MrSimonEmms | `ghcr.io/mrsimonemms/devcontainers/tcld:1` | `1.0.2` |
| Zigflow | MrSimonEmms | `ghcr.io/mrsimonemms/devcontainers/zigflow:1` | `1.0.1` |
| Rojo | Ryan Luu | `ghcr.io/ryanlua/features/rojo:0` | `0.2.1` |
| .NET User Secrets Persistence | Daniel Lindemann | `ghcr.io/daniellindemann/dev-container-features/dotnet-usersecrets-persistence:0` | `0.0.1` |
| Starship Plugin | Tobias Chavarria | `ghcr.io/tobiaschc/devcontainer-features/starship:1` | `1.0.0` |
| arkade-get | Joe Bowbeer | `ghcr.io/joebowbeer/devcontainers-features/arkade-get:1` | `1.1.4` |
| crossplane | Joe Bowbeer | `ghcr.io/joebowbeer/devcontainers-features/crossplane:1` | `1.0.2` |
| Antidote (Zsh plugins) | Pedro Rodrigues | `ghcr.io/pirpedro/features/antidote:1` | `1.0.1` |
| chezmoi (dotfiles manager) | Pedro Rodrigues | `ghcr.io/pirpedro/features/chezmoi:1` | `1.0.1` |
| Dev Gadgets | Pedro Rodrigues | `ghcr.io/pirpedro/features/dev-gadgets:1` | `1.0.1` |
| Just | Pedro Rodrigues | `ghcr.io/pirpedro/features/just:1` | `1.0.0` |
| Azure linux Docker (docker-outside-of-docker) | Victor Maznev | `ghcr.io/bullmastiffo/devcontainers-features/azurelinux-docker-outside-of-docker:1` | `1.0.0` |
| Mailpit (via Homebrew) | ANh Nguyễn (TakahashiNguyen) | `ghcr.io/takahashinguyen/devcontainer-features/mailpit-homebrew:1` | `1.1.1` |
| MinIO Client (via Homebrew) | ANh Nguyễn (TakahashiNguyen) | `ghcr.io/takahashinguyen/devcontainer-features/minio-client-homebrew:1` | `1.0.1` |
| MinIO (via Homebrew) | ANh Nguyễn (TakahashiNguyen) | `ghcr.io/takahashinguyen/devcontainer-features/minio-homebrew:2` | `2.1.21` |
| jsonnet (via GitHub Releases) | Olivier Lemasle | `ghcr.io/olivierlemasle/devcontainers-features/jsonnet:1` | `1.0.0` |
| tauri | Olivier Lemasle | `ghcr.io/olivierlemasle/devcontainers-features/tauri:1` | `1.0.0` |
| SAP BTP CAP Dev Stack | Navin Krishnan | `ghcr.io/navinkrishnan/devcontainer-features-btp/btp-cap-dev-stack:1` | `1.0.11` |
| SAP CAP cds-dk | Navin Krishnan | `ghcr.io/navinkrishnan/devcontainer-features-btp/cds-dk:1` | `1.0.2` |
| Cloud Foundry CLI | Navin Krishnan | `ghcr.io/navinkrishnan/devcontainer-features-btp/cf:1` | `1.0.4` |
| Helm package manager for Kubernetes | Navin Krishnan | `ghcr.io/navinkrishnan/devcontainer-features-btp/helm:1` | `1.0.2` |
| SAP Cloud MTA Build Tool (mbt) | Navin Krishnan | `ghcr.io/navinkrishnan/devcontainer-features-btp/mbt:1` | `1.0.1` |
| CN Buildpacks Pack CLI | Navin Krishnan | `ghcr.io/navinkrishnan/devcontainer-features-btp/pack:1` | `1.0.2` |
| nats-server (via GitHub Releases) | Kapil Sachdeva | `ghcr.io/ksachdeva/devcontainer-features/nats-server:1` | `1.0.0` |
| nats-top (via GitHub Releases) | Kapil Sachdeva | `ghcr.io/ksachdeva/devcontainer-features/nats-top:1` | `1.0.0` |
| natscli (via GitHub Releases) | Kapil Sachdeva | `ghcr.io/ksachdeva/devcontainer-features/natscli:1` | `1.0.0` |
| presenterm (via GitHub Releases) | Kapil Sachdeva | `ghcr.io/ksachdeva/devcontainer-features/presenterm:1` | `1.0.0` |
| Claude Code | siri404 | `ghcr.io/siri404/devcontainer-ai-features/claude-code:1` | `1.0.1` |
| Google Cloud CLI | siri404 | `ghcr.io/siri404/devcontainer-ai-features/gcloud:1` | `1.0.0` |
...
| Automatic File Headers | baxyz | `ghcr.io/helpers4/devcontainer/auto-header:1` | `1.2.4` |
...
| helpers4 Common Library | baxyz | `ghcr.io/helpers4/devcontainer/helpers4-common:1` | `1.2.3` |
...
| Org Workspace | baxyz | `ghcr.io/helpers4/devcontainer/org-workspace:1` | `1.0.1` |
| Automatic Package Installation | baxyz | `ghcr.io/helpers4/devcontainer/package-auto-install:1` | `1.2.3` |
| Peon Ping — AI Agent Sound Notifications | baxyz | `ghcr.io/helpers4/devcontainer/peon-ping:1` | `1.3.2` |
...
| Minio Server | Atomys | `ghcr.io/42atomys/devcontainers-features/minio-server:1` | `1.0.0` |
| Redis CLI | Atomys | `ghcr.io/42atomys/devcontainers-features/redis-cli:1` | `1.0.0` |
| NeoVim (from prebuilt binary) | Marcos Bolaños | `ghcr.io/marcosbolanos/devcontainer-features/neovim-prebuilt:1` | `1.0.0` |
| My Favorite Color | Carlos Eduardo Monti | `ghcr.io/slaytanic/devcontainer/color:1` | `1.0.3` |
| Hello, World! | Carlos Eduardo Monti | `ghcr.io/slaytanic/devcontainer/hello:1` | `1.0.2` |
| Watchman | Carlos Eduardo Monti | `ghcr.io/slaytanic/devcontainer/watchman:1` | `1.0.0` |
| Elixir (via asdf) | Rayyan Abdul-Wahhab | `ghcr.io/rabdulwahhab/devcontainer-features/elixir-asdf:1` | `1.0.2` |
| Erlang (via asdf) | Rayyan Abdul-Wahhab | `ghcr.io/rabdulwahhab/devcontainer-features/erlang-asdf:1` | `1.0.1` |
| Active Storage | Rails Core Team | `ghcr.io/rails/devcontainer/features/activestorage:1` | `1.1.1` |
| Bun | Rails Core Team | `ghcr.io/rails/devcontainer/features/bun:1` | `1.0.2` |
...
| Ruby | Rails Core Team | `ghcr.io/rails/devcontainer/features/ruby:2` | `2.2.5` |
...
| Intel Realsense SDK | XingxinHE | `ghcr.io/xingxinhe/devcontainer-features/realsense:1` | `1.0.0` |
| Robotpkg | XingxinHE | `ghcr.io/xingxinhe/devcontainer-features/robotpkg:1` | `1.0.0` |
| Zivid | XingxinHE | `ghcr.io/xingxinhe/devcontainer-features/zivid:1` | `1.0.0` |
| Aikido Secrets Pre-commit Hook | ProxayFox | `ghcr.io/proxayfox/devcontainer-features/aikido-precommit:1` | `1.0.0` |
| ClickHouse Local CLI | ProxayFox | `ghcr.io/proxayfox/devcontainer-features/clickhouse-local:1` | `1.0.0` |
| lazydocker | ProxayFox | `ghcr.io/proxayfox/devcontainer-features/lazydocker:1` | `1.1.0` |
| Databricks CLI | KingBain | `ghcr.io/kingbain/devcontainer-features-databricks/databricks-cli:0` | `0.0.1` |
| .config/ | devcontainer-config | `ghcr.io/devcontainer-config/features/dot-config:4` | `4.0.0` |
| Features | devcontainer-config | `ghcr.io/devcontainer-config/features/features:0` | `0.1.0` |
| Unset Git Credential Helper | devcontainer-config | `ghcr.io/devcontainer-config/features/unset-git-credential-helper:0` | `0.1.0` |
| Initialize User | devcontainer-config | `ghcr.io/devcontainer-config/features/user-init:3` | `3.0.0` |
| Android Debug Bridge (adb) and Fastboot | Evit15 | `ghcr.io/Evit15/devcontainer-features/adb-fastboot:1` | `1.0.1` |
| fexec | roboslone | `ghcr.io/roboslone/go-framework/fexec:1` | `1.0.0` |
| Oh My Posh | Bipin Paul | `ghcr.io/iambipinpaul/devcontainer-features/oh-my-posh:1` | `1.1.0` |
| Firewall | w3cj | `ghcr.io/w3cj/devcontainer-features/firewall:0` | `0.0.2` |
| Gemini CLI | marblejenka | `ghcr.io/marblejenka/devcontainer-feature/gemini-cli:0` | `0.1.5` |
| TLA+ Tools | marblejenka | `ghcr.io/marblejenka/devcontainer-feature/tlaplus:0` | `0.0.3` |
| Fortran Package Manager | ttyrho | `ghcr.io/ttyrho/devcontainer-features/fpm:1` | `1.0.1` |
| GNU Compiler Collection | ttyrho | `ghcr.io/ttyrho/devcontainer-features/gcc:1` | `1.1.0` |
| GNU Fortran | ttyrho | `ghcr.io/ttyrho/devcontainer-features/gfortran:1` | `1.0.0` |
| Doppler CLI | Doppler Team | `ghcr.io/dopplerhq/devcontainer-features/doppler-cli:1` | `1.0.0` |
| Prepare Volume Permissions | Doppler Team | `ghcr.io/dopplerhq/devcontainer-features/volume-permissions:1` | `1.0.0` |
| Install Apptainer | Miguel Rodo | `ghcr.io/miguelrodo/devcontainerfeatures/apptainer:1` | `1.1.4` |
| Container Metadata Injector | Miguel Rodo | `ghcr.io/miguelrodo/devcontainerfeatures/build-info:1` | `1.4.0` |
| CmdStan | Miguel Rodo | `ghcr.io/miguelrodo/devcontainerfeatures/cmdstan:1` | `1.1.2` |
...
| Fish Shell with Starship Prompt | esimkowitz | `ghcr.io/esimkowitz/devcontainer-features/fish-starship:1` | `1.2.2` |
...
| PHP Extensions via PIE | iyaki | `ghcr.io/iyaki/devcontainer-features/pie-extensions:2` | `2.1.0` |
...
| Agents Workspace | wcgomes | `ghcr.io/wcgomes/devcontainer-features/agents-workspace:0` | `0.3.1` |
| opencode CLI | wcgomes | `ghcr.io/wcgomes/devcontainer-features/opencode:0` | `0.3.7` |
| Ansible | sliekens | `ghcr.io/sliekens/devcontainer-features/ansible:1` | `1.0.0` |
| Ansible Core | sliekens | `ghcr.io/sliekens/devcontainer-features/ansible-core:1` | `1.0.0` |
| Ansible Lint | sliekens | `ghcr.io/sliekens/devcontainer-features/ansible-lint:1` | `1.0.0` |
| Aspire CLI | sliekens | `ghcr.io/sliekens/devcontainer-features/aspire-cli:1` | `1.3.4` |
| Bitwarden Agent Access | sliekens | `ghcr.io/sliekens/devcontainer-features/bitwarden-agent-access:1` | `1.0.1` |
| Bitwarden CLI | sliekens | `ghcr.io/sliekens/devcontainer-features/bitwarden-cli:1` | `1.1.2` |
| Bitwarden Secrets Manager CLI | sliekens | `ghcr.io/sliekens/devcontainer-features/bitwarden-secrets-manager:1` | `1.1.2` |
| Claude Code | sliekens | `ghcr.io/sliekens/devcontainer-features/claude:1` | `1.2.4` |
| Codex CLI | sliekens | `ghcr.io/sliekens/devcontainer-features/codex:1` | `1.1.3` |
| GitHub Copilot | sliekens | `ghcr.io/sliekens/devcontainer-features/copilot:1` | `1.1.2` |
| GitHub CLI | sliekens | `ghcr.io/sliekens/devcontainer-features/github-cli:1` | `1.1.3` |
| Grok Build | sliekens | `ghcr.io/sliekens/devcontainer-features/grok-build:1` | `1.0.2` |
| Mistral Vibe | sliekens | `ghcr.io/sliekens/devcontainer-features/mistral-vibe:1` | `1.2.1` |
| Mono | sliekens | `ghcr.io/sliekens/devcontainer-features/mono:1` | `1.0.0` |
| Oh My Pi | sliekens | `ghcr.io/sliekens/devcontainer-features/omp:1` | `1.0.0` |
| OpenCode | sliekens | `ghcr.io/sliekens/devcontainer-features/opencode:1` | `1.0.3` |
| Pi | sliekens | `ghcr.io/sliekens/devcontainer-features/pi:1` | `1.0.0` |
| Rename Container User | sliekens | `ghcr.io/sliekens/devcontainer-features/rename-user:1` | `1.0.1` |
...
| Docker inside Docker | PostFinance AG | `ghcr.io/postfinance/devcontainer-features/docker-in:1` | `1.0.0` |
...
| GitLab CLI | PostFinance AG | `ghcr.io/postfinance/devcontainer-features/gitlab-cli:1` | `1.0.1` |
...
| Python | PostFinance AG | `ghcr.io/postfinance/devcontainer-features/python:1` | `1.2.0` |
| Rust | PostFinance AG | `ghcr.io/postfinance/devcontainer-features/rust:1` | `1.1.0` |
| SonarScanner CLI | PostFinance AG | `ghcr.io/postfinance/devcontainer-features/sonar-scanner-cli:1` | `1.1.0` |
| System Packages | PostFinance AG | `ghcr.io/postfinance/devcontainer-features/system-packages:1` | `1.0.0` |
| Terraform | PostFinance AG | `ghcr.io/postfinance/devcontainer-features/terraform:1` | `1.0.0` |
...
| Roc (nightly, via GitHub Releases) | NicoVIII | `ghcr.io/nicoviii/devcontainer-features/roc:0` | `0.1.0` |
...
| Codex CLI | cjcrobin | `ghcr.io/cjcrobin/devcontainer-features/codexcli:1` | `1.0.0` |
| Playwright CLI | cjcrobin | `ghcr.io/cjcrobin/devcontainer-features/playwright-cli:1` | `1.0.0` |
...
| betterleaks | kuju63 | `ghcr.io/kuju63/devcontainer-features/betterleaks:1` | `1.3.0` |
...
| Bash Language Server (optional shellcheck and shfmt) | Stephen Mott | `ghcr.io/srzstephen/devcontainer-features/bash-language-server:1` | `1.0.1` |
| Claude Code | Stephen Mott | `ghcr.io/srzstephen/devcontainer-features/claude-code:1` | `1.0.1` |
| gitlab-ci-local | Stephen Mott | `ghcr.io/srzstephen/devcontainer-features/gitlab-ci-local:1` | `1.0.1` |
| GitLab CLI | Stephen Mott | `ghcr.io/srzstephen/devcontainer-features/gitlab-cli:1` | `1.0.1` |
| just | Stephen Mott | `ghcr.io/srzstephen/devcontainer-features/just:1` | `1.0.1` |
| Kiro CLI | Stephen Mott | `ghcr.io/srzstephen/devcontainer-features/kiro-cli:1` | `1.0.1` |
...
| Dev Container Development Certificates | dnegstad | `ghcr.io/dnegstad/devcontainer-dev-certs/devcontainer-dev-certs:1` | `1.4.1` |
...
| LiquiLens Evidence Carrier | beepboop2025 | `ghcr.io/beepboop2025/liquilens-devcontainer-features/liquilens-evidence:1` | `1.0.0` |
| jqweb | zafnz | `ghcr.io/zafnz/devcontainer-features/jqweb:1` | `1.0.0` |
