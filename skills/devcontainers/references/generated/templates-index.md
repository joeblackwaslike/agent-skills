...
| Swift | Swift Server Workgroup | `ghcr.io/swift-server/swift-devcontainer-template/swift:2.8.0` | `2.8.0` |
| UNSW cs3231 OS Development | Hamish Cox | `ghcr.io/hamishwhc/cs3231-devcontainer/cs3231:1.0.0` | `1.0.0` |
| MultiversX: Smart Contracts Development (Rust) | MultiversX | `ghcr.io/multiversx/mx-template-devcontainers/smart-contracts-rust:0.5.1` | `0.5.1` |
...
| scicloj datascience devcontainer template | Carsten Behring | `ghcr.io/scicloj/devcontainer-templates/scicloj:2.0.3` | `2.0.3` |
...
| SAP CAP | NickChecan | `ghcr.io/the-nefarious-developer/devcontainer-templates/sap-cap-javascript-node:1.0.0` | `1.0.0` |
| SAP CAP | NickChecan | `ghcr.io/the-nefarious-developer/devcontainer-templates/sap-cap-typescript-node:1.0.0` | `1.0.0` |
| Go Development Toolkit | irfansofyana | `ghcr.io/irfansofyana/devcontainer-templates/go-toolkit:1.0.3` | `1.0.3` |
...
| Devcontainers Ziglang template | fardragon | `ghcr.io/fardragon/devcontainers-zig-template/ziglang:0.4.1` | `0.4.1` |
...
| uv | mattmazzola | `ghcr.io/mattmazzola/devcontainers/uv:1.0.0` | `1.0.0` |
| AcademicDocker template | Romain Ferrali | `ghcr.io/rferrali/devcontainer-templates/academic-docker:1.0.1` | `1.0.1` |
| Ansible | jhoareaumarion | `ghcr.io/jhoareaumarion/devcontainers/ansible:1.0.0` | `1.0.0` |
| Ansible + Bitwarden CLI + Kubernetes + OpenTofu | jhoareaumarion | `ghcr.io/jhoareaumarion/devcontainers/ansible-bitwarden-kubernetes-tofu:1.0.1` | `1.0.1` |
| kubernetes | jhoareaumarion | `ghcr.io/jhoareaumarion/devcontainers/kubernetes:1.0.2` | `1.0.2` |
| OpenTofu | jhoareaumarion | `ghcr.io/jhoareaumarion/devcontainers/tofu:1.0.0` | `1.0.0` |
...
| C++ | Philips Software | `ghcr.io/philips-software/amp-devcontainer/cpp:8.2.0` | `8.2.0` |
| Embedded C++ | Philips Software | `ghcr.io/philips-software/amp-devcontainer/embedded-cpp:8.2.0` | `8.2.0` |
| Embedded Rust | Philips Software | `ghcr.io/philips-software/amp-devcontainer/embedded-rust:8.2.0` | `8.2.0` |
| Rust | Philips Software | `ghcr.io/philips-software/amp-devcontainer/rust:8.2.0` | `8.2.0` |
...
| Bun | nozaq | `ghcr.io/bare-devcontainer/templates/bun:1.1.0` | `1.1.0` |
| Debian | nozaq | `ghcr.io/bare-devcontainer/templates/debian:1.3.0` | `1.3.0` |
| Deno | nozaq | `ghcr.io/bare-devcontainer/templates/deno:1.1.0` | `1.1.0` |
| Go | nozaq | `ghcr.io/bare-devcontainer/templates/golang:1.4.0` | `1.4.0` |
| mise | nozaq | `ghcr.io/bare-devcontainer/templates/mise:1.4.0` | `1.4.0` |
| Node.js | nozaq | `ghcr.io/bare-devcontainer/templates/node:1.2.0` | `1.2.0` |
| OpenTofu | nozaq | `ghcr.io/bare-devcontainer/templates/opentofu:1.1.0` | `1.1.0` |
| Node.js (pnpm) | nozaq | `ghcr.io/bare-devcontainer/templates/pnpm:1.1.0` | `1.1.0` |
| Rust | nozaq | `ghcr.io/bare-devcontainer/templates/rustup:1.5.0` | `1.5.0` |
| Java (Temurin) | nozaq | `ghcr.io/bare-devcontainer/templates/temurin:1.1.0` | `1.1.0` |
