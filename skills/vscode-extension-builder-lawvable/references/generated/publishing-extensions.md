...
sha256: "25882d9e63933b7d37259a3ab99770df11981beb9b7a6c1a75f80e8fcd82b3c4"
---
...
- 
Create a Service Connection (Azure DevOps)
...
- 
Create a Managed Identity (Azure)
...
- 
Retrieve Managed Identity Resource ID (one-time)
...
- 
Authorize the Identity in Visual Studio Marketplace
...
Sample YAML tasks. Replace with the extension directory path.
...
- 
If you don't have an Azure DevOps organization yet, follow the steps in the [Create an organization](https://learn.microsoft.com/azure/devops/organizations/accounts/create-organization) article.

- 
Go to the [Azure DevOps portal](https://go.microsoft.com/fwlink/?LinkId=307137), and select your organization.
...
- 
Manually, using `vsce package` to package the extension into the installable VSIX format and then uploading it to the [Visual Studio Marketplace publisher management page](https://marketplace.visualstudio.com/manage):
...
- 
Manually, from the [Visual Studio Marketplace publisher management page](https://marketplace.visualstudio.com/manage) by clicking **More Actions > Remove**:
