...
fetched_at: "2026-05-26T10:34:19.240Z"
sha256: "19dc4fc724e6a8aec797d99aecfc518fc62823f77c05786d3c76af4f73e988c5"
---
...
- Implement the tool in your extension code by using the [Language Model API reference](https://code.visualstudio.com/api/references/vscode-api#lm)
...
`icon`
The icon to display for the tool in the UI.

`userDescription`
User-friendly description of the tool, used for displaying in the UI.
...
- 
On activation of the extension, register the tool with [vscode.lm.registerTool](https://code.visualstudio.com/api/references/vscode-api#lm.registerTool).
...
- 
Create a class that implements the [vscode.LanguageModelTool<>](https://code.visualstudio.com/api/references/vscode-api#LanguageModelTool%3CT%3E) interface.
