---
source: "https://raw.githubusercontent.com/github/docs/main/content/rest/authentication/authenticating-to-the-rest-api.md"
fetched_at: "2026-07-13T06:58:22.643Z"
sha256: "6e755a4b84edff0768fbbfe0ea0f21d7ecb9b11cbaf6f32325b43c47b058f525"
---
...
If this is not possible, you can store your token as a secret and use the name of your secret in your {% data variables.product.prodname_actions %} workflow. For more information about secrets, see [AUTOTITLE](/actions/how-tos/write-workflows/choose-what-workflows-do/use-secrets).
...
In the following example workflow, replace `PATH` with the path of the endpoint. For more information about the path, see [AUTOTITLE](/rest/using-the-rest-api/getting-started-with-the-rest-api?tool=cli#path).{% ifversion ghes %} Replace `HOSTNAME` with the name of {% data variables.location.product_location %}.{% endif %}
...
* [AUTOTITLE](/rest/using-the-rest-api/getting-started-with-the-rest-api#authentication)
