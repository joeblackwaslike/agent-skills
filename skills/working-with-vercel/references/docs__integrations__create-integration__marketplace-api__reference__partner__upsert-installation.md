...
sha256: "cdab4c340c17919fe2564e8e3cee69fe0f4085e04c841e6c2ab144f7afc346e3"
---
...
**When to implement**: Vercel calls this endpoint when a customer [installs your integration](/docs/integrations/create-integration/marketplace-flows), sending credentials (access token), scopes, and account info. Store the installation ID, configure the account on your side, and save the access token for calling Vercel APIs.
