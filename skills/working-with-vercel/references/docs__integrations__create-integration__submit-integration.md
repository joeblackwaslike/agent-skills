...
sha256: "b948b69cbe9c79e2a12e4f54d46aed526dabae396943e53bdd2a0094a1aeb36b"
---
...
To let users import resources that already exist on your platform into their Vercel installation, specify an **Import Resource URL**. When a user chooses **Import Existing** for your integration, Vercel redirects their browser to this URL to start the import flow on your integration server.

See the [Import existing resources flow](/docs/integrations/create-integration/marketplace-flows#import-existing-resources-flow) for the full contract, including the query parameters Vercel appends to this URL and the steps your integration server must perform before returning the user to Vercel.

Setting this field enables the **Import Existing** option for connected installations, which also require a **Redirect URL**. To enable importing for native marketplace installations, contact Vercel.
...
- **Required**:
  - **Yes**: For a connectable account integration, or the first time you set up a native integration
  - **No**: When you are only adding a product to an integration that already accepted the partner terms for that integration type. Vercel may still prompt you when you add your first product

Before you can publish, you must accept the partner terms that match how customers use your integration:

| Integration type | How customers use your integration | Applicable partner terms |
| ---------------- | ----------------------------------- | ------------------------- |
| [Native integration](/docs/integrations#native-integrations) | Customers pick plans for your products in the Vercel dashboard, and Vercel bills them through their Vercel account. | The **Integrations Agreement** covers the marketplace partner program for native billing, including charges, payouts, and how you list products. That program builds on the [Vercel Integrations Marketplace Agreement](/legal/integrations-marketplace-agreement). |
| [Connectable account integration](/docs/integrations#connectable-accounts) | Customers link an existing account with your service. Vercel does not sell or renew your product subscription as part of the native installation flow. | The [Vercel Integrations Marketplace Agreement](/legal/integrations-marketplace-agreement), which governs listing and distributing your integration on the Integrations Marketplace. |
