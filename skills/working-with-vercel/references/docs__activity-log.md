...
sha256: "89b5c1a5307d6dce741939f4c3fa36886cc8bcc5852af393fc0bd2a2d2ca1ec2"
---
...
- [Vercel Pricing](https://vercel.com/pricing?from=related&source_path=%2Fdocs%2Factivity-log&source_site=vercel-docs&relationship=related) — Choose a Vercel plan and compare features and usage pricing.
...
- [Find a project by id or name](https://vercel.com/docs/rest-api/projects/find-a-project-by-id-or-name?from=related&source_path=%2Fdocs%2Factivity-log&source_site=vercel-docs&relationship=related) — GET /v9/projects/{idOrName} — Get the information for a specific project by passing either the project \\`id\\` or \\`name\\
- [Upload a project avatar](https://vercel.com/docs/rest-api/projects/upload-a-project-avatar?from=related&source_path=%2Fdocs%2Factivity-log&source_site=vercel-docs&relationship=related) — POST /v1/projects/{idOrName}/avatar — Upload an image as the avatar of the project identified by \\`idOrName\\`. The reque
