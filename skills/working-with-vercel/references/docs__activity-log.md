...
sha256: "aee3e95645a48b9c9ac810974d3fca1cbf4dae07b27d5cbda0f82b6c1eb94199"
---
...
- [Activity Log now available in Vercel CLI](https://vercel.com/changelog/activity-log-now-available-in-vercel-cli?from=related&source_path=%2Fdocs%2Factivity-log&source_site=vercel-docs&relationship=related)
- [Activity log now tracks 100% of team and project changes](https://vercel.com/changelog/activity-log-now-tracks-100-of-team-and-project-changes?from=related&source_path=%2Fdocs%2Factivity-log&source_site=vercel-docs&relationship=related)
- [Expanded Audit Log coverage, now delivered through Vercel Drains](https://vercel.com/changelog/expanded-audit-log-coverage-now-delivered-through-vercel-drains?from=related&source_path=%2Fdocs%2Factivity-log&source_site=vercel-docs&relationship=related)
- [You can now view the Activity Log at a project-level](https://vercel.com/changelog/you-can-now-view-the-activity-log-at-a-project-level?from=related&source_path=%2Fdocs%2Factivity-log&source_site=vercel-docs&relationship=related)
- [How to add and manage environment variables on Vercel](https://vercel.com/kb/guide/how-to-add-vercel-environment-variables?from=related&source_path=%2Fdocs%2Factivity-log&source_site=vercel-docs&relationship=related) — Add environment variables to Vercel through the dashboard, CLI, or REST API, scope them to each environment, and pull th
- [List User Events](https://vercel.com/docs/rest-api/user/list-user-events?from=related&source_path=%2Fdocs%2Factivity-log&source_site=vercel-docs&relationship=related) — GET /v3/events — Retrieves a list of "events" generated by the User on Vercel. Events are generated when the User perfor
- [June 2020](https://vercel.com/blog/changelog-june-2020?from=related&source_path=%2Fdocs%2Factivity-log&source_site=vercel-docs&relationship=related)
- [List Event Types](https://vercel.com/docs/rest-api/user/list-event-types?from=related&source_path=%2Fdocs%2Factivity-log&source_site=vercel-docs&relationship=related) — GET /v1/events/types — Returns the list of user-facing event types with descriptions.
- [July 2020](https://vercel.com/blog/changelog-july-2020?from=related&source_path=%2Fdocs%2Factivity-log&source_site=vercel-docs&relationship=related)
- [March 2020](https://vercel.com/blog/changelog-march-2020?from=related&source_path=%2Fdocs%2Factivity-log&source_site=vercel-docs&relationship=related)
- [List projects in a microfrontends group](https://vercel.com/docs/rest-api/microfrontends/list-projects-in-a-microfrontends-group?from=related&source_path=%2Fdocs%2Factivity-log&source_site=vercel-docs&relationship=related) — GET /v1/microfrontends/groups/{groupId}/projects — Get the microfrontends for a given group ID.
- [Update the microfrontends settings](https://vercel.com/docs/rest-api/projects/update-the-microfrontends-settings?from=related&source_path=%2Fdocs%2Factivity-log&source_site=vercel-docs&relationship=related) — PATCH /v1/projects/{projectId}/microfrontends — Update the microfrontends settings for a project.

Full cross-link map for this page: [/docs/activity-log.graph.md](/docs/activity-log.graph.md?from=related&source_path=%2Fdocs%2Factivity-log&source_site=vercel-docs&relationship=graph)
<!-- /docsgraph:related -->
...
| ai-gateway-byok-model-mappings-updated | Active | A user changed which gateway models an AI Gateway BYOK credential maps to custom model IDs. |
...
| ai-gateway-hipaa-compliance-toggled | Active | Required HIPAA-compliant providers was enabled or disabled for a team on AI Gateway. |
| ai-gateway-inference-regions-updated | Active | The AI Gateway inference region pin was updated for a team. |
...
| ai-gateway-prompt-training-opt-out-toggled | Active | The prompt training opt-out was enabled or disabled for a team on AI Gateway. |
...
| ai-gateway-virtual-model-config-deleted | Active | A user deleted an AI Gateway virtual model. |
...
| ai-gateway-zero-data-retention-toggled | Active | Required Zero Data Retention was enabled or disabled for a team on AI Gateway. |
...
| billing-settings-updated | Active | Billing settings were updated. |
...
| deployment-protection-access-requests | Active | Deployment Protection access requests were updated. |
...
| domain-ech-change | Active | Encrypted Client Hello enrollment was changed for a domain. |
...
| integration-configuration-credential-revoked | Active | An installed integration revoked an access token it used to call the Vercel API. |
...
| project-custom-environment-schedules-default-updated | Active | The default state for new schedules in a custom environment was updated. |
...
| shared-env-variable-repo-link | Active | A shared environment variable was linked to a git repository, exposing it to Vercel CI runs for that repository. |
| shared-env-variable-repo-unlink | Active | A shared environment variable was unlinked from a git repository. |
...
| strict-connectors | Active | Strict connectors settings were updated. |
...
| user-emu-account-update-opted-in | Active | A user opted in to the enterprise-managed account transition for a team. |
| user-emu-account-update-opted-out | Active | A user opted out of the enterprise-managed account transition for a team. |
