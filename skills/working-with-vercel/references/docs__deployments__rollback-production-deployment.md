...
sha256: "81b615154d9d4711bde6d3f158646a5da7647f114937b5e35ac356736c61c804"
---
...
# 2. Roll back immediately to restore service (pass the URL or ID to roll back to)
...
When production is broken, restoring service is the priority. Roll back by pointing production at a previous deployment. Pass the URL or deployment ID you want to roll back to:

```bash filename="terminal"
vercel rollback <previous-deployment-url-or-id>
```

This points production traffic to the deployment you specify without rebuilding. The rollback happens at the routing layer, so it takes effect within seconds.
