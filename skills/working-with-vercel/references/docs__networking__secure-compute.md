...
> **💡 Note:** If you only need static IP addresses for IP allowlisting, without features like dedicated infrastructure, VPC peering, or complete network isolation, consider [Static IPs](/docs/networking/static-ips).
...
> **💡 Note:** Self-service network creation isn't available to all Enterprise teams. If you don't see the option to create a network in the steps below, contact your Vercel account team to provision a Secure Compute network for you.

You can create Secure Compute networks directly from the Vercel dashboard:

1. Navigate to your team's **Settings** → [**Networking**](https://vercel.com/d?to=%2F%5Bteam%5D%2F%7E%2Fsettings%2Fnetworking%23secure-compute\&title=Networking).
...
1. **Create networks in different regions**: Navigate to your team's **Settings** → [**Networking**](https://vercel.com/d?to=%2F%5Bteam%5D%2F%7E%2Fsettings%2Fnetworking%23secure-compute\&title=Networking) and click **Create Network** to create Secure Compute networks in your primary and failover regions.
2. **Connect project environments**: In your project's **Settings** → [**Networking**](https://vercel.com/d?to=%2F%5Bteam%5D%2F%5Bproject%5D%2Fsettings%2Fnetworking%23secure-compute\&title=Networking), configure each environment (Production, Preview, etc.) with an **Active Network** (primary) and an optional **Passive Network** (failover).
...
1. Navigate to your project's **Settings** → [**Networking**](https://vercel.com/d?to=%2F%5Bteam%5D%2F%5Bproject%5D%2Fsettings%2Fnetworking%23secure-compute\&title=Networking).
...
1. **Create a Secure Compute network**: Navigate to your team's **Settings** → [**Networking**](https://vercel.com/d?to=%2F%5Bteam%5D%2F%7E%2Fsettings%2Fnetworking%23secure-compute\&title=Networking) and click **Create Network**. Select your desired region and optionally specify a CIDR block. The CIDR blocks of your Secure Compute network and your AWS VPC must not overlap.
