...
sha256: "0263dcd3969eed98a4f23b86b3aadc71bc9842ce2d4a6ed000ea37dc9877d08e"
---
...
Use the **HTTP Source URL** and generated Bearer token that Panther provides when you create the Vercel source. Vercel sends the token in the `Authorization` header using the `Bearer <token>` format.

See [Drain Audit Logs to Panther](/docs/drains/audit-logs-to-panther) for source setup and destination fields.
