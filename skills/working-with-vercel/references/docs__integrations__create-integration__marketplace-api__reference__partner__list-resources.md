...
sha256: "b34f6cf4231571937e1d33adc32d4255902498180783c870d9dd3f18830e31c4"
---
...
**When to implement**: This endpoint is deprecated. New integrations don't need to implement it. Vercel stores resource state locally after provisioning and uses Get Resource for per-resource lookups instead.

```http
GET /v1/installations/{installationId}/resources
```

Lists all Resources. This endpoint has been deprecated.
