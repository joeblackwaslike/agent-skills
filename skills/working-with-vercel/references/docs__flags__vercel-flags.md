...
- [Vercel Flags is now in public beta](https://vercel.com/changelog/vercel-flags-is-now-in-public-beta?from=related&source_path=%2Fdocs%2Fflags%2Fvercel-flags&source_site=vercel-docs&relationship=related)
...
Flags can return boolean, string, number, or JSON values. This lets you use Vercel Flags for feature gates, experiments, thresholds, and structured configuration.
...
- **Targeting and segments**: Control who sees what using user attributes, splits, progressive rollouts, or reusable [segments](/docs/flags/vercel-flags/dashboard/segments) like "Beta Testers" or "Internal Team."
