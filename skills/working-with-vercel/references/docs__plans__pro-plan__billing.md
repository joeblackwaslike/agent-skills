...
You will be charged for on-demand usage. In most cases, these charges appear on your next regular invoice at the end of the billing cycle. However, if your accrued usage crosses a billing threshold, you may receive a [partial invoice](/docs/pricing/understanding-my-invoice#partial-invoices) before the cycle ends. Partial invoices cover only the usage that triggered the threshold.
