...
Table of Contents
      ...
      Formatting
      Indentation - Line Length and Long Strings - Pipelines - Control Flow - Case statement - Variable expansion - Quoting

      Features and Bugs
      ShellCheck - Command Substitution - Test, [… ], and [[… ]] - Testing Strings - Wildcard Expansion of Filenames - Eval - Arrays - Pipes to While - Arithmetic - Aliases

      Naming Conventions
      Function Names - Variable Names - Constants and Environment Variable Names - Source Filenames - Use Local Variables - Function Location - main
...
The ShellCheck project identifies common bugs and
