...
source: "https://www.dolthub.com/docs/concepts/dolt/rdbms/backups.md"
fetched_at: "2026-06-15T20:08:28.186Z"
sha256: "9a82483c9200b5fd9d9f5153c79599be5ef014978b9e6f720c4a290befc27100"
---
...
Dolt does not support any of the [MySQL backup methods](https://dev.mysql.com/doc/refman/8.0/en/backup-methods.html) except the `mysqldump` method. Dolt can create a dump using the [`dolt dump` command](/cli-reference/cli#dolt-dump) or `mysqldump` connected to the running Dolt server. 
