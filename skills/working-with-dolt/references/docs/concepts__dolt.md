...
source: "https://www.dolthub.com/docs/concepts/dolt.md"
fetched_at: "2026-06-15T20:08:28.186Z"
sha256: "5e6ae4fcf5314d4c8921654296c0f3e5993de0c3a3de13c4638c04e86d1a4cdd"
---
...
In order to achieve the above at scale, we needed to start at the bottom; the storage engine of the database. [Dolt is built from the storage engine up](/architecture/architecture) to offer you the Git experience in a SQL database.  

In this section of the documentation, we will explain [Git](/concepts/dolt/git/), [SQL](/concepts/dolt/sql/), and [Relational Database Management System (RDBMS)](/concepts/dolt/rdbms/) concepts and how we applied them in Dolt using the above axioms.
