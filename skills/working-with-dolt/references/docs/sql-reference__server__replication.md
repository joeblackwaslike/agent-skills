...
source: "https://www.dolthub.com/docs/sql-reference/server/replication.md"
fetched_at: "2026-06-15T20:08:28.186Z"
sha256: "1c72552582a06f503ba738b63ee1970f9350887280065adbf81980fcae12e588"
---
...
[Direct vs Remote Replication](/sql-reference/server/replication#direct-vs.-remote-replication) for more
...
1. [`@@dolt_replicate_to_remote`](/sql-reference/version-control/dolt-sysvars#doltreplicatetoremote).
...
1. [`@@dolt_read_replica_remote`](/sql-reference/version-control/dolt-sysvars#doltreadreplicaremote).
   **Required for a replica.** The replica will pull from the remote named at transaction start.
1. [`@@dolt_replicate_heads`](/sql-reference/version-control/dolt-sysvars#doltreplicateheads). **Either this
...
1. [`@@dolt_replicate_all_heads`](/sql-reference/version-control/dolt-sysvars#doltreplicateallheads).
...
1. [`@@dolt_replication_remote_url_template`](/sql-reference/version-control/dolt-sysvars#doltreplicationremoteurltemplate).
...
variable](/sql-reference/version-control/dolt-sysvars#doltreplicatetoremote). You
...
variable](/sql-reference/version-control/dolt-sysvars#doltasyncreplication). This
...
variable`](/sql-reference/version-control/dolt-sysvars#doltreadreplicaremote). I
also must configure which branches (ie. HEADs) I would like to
replicate using either
[`@@dolt_replicate_heads`](/sql-reference/version-control/dolt-sysvars#doltreplicateheads)
to pick specific branches or
[`@@dolt_replicate_all_heads`](/sql-reference/version-control/dolt-sysvars#doltreplicateallheads)
...
instead](/sql-reference/server/replication#direct-to-standby-replication).
