...
source: "https://www.dolthub.com/docs/sql-reference/version-control/merges.md"
fetched_at: "2026-06-15T20:08:28.186Z"
sha256: "e383e29198210bf0936c3b946f04e4a79ba5ad41405227ab6004739cfa8aa5d2"
---
...
[common-ancestor](/cli-reference/cli#dolt-merge-base) and describes why the `ours` and `theirs`
...
or resolve the schema conflict using [`dolt_conflicts_resolve()`](/sql-reference/version-control/dolt-sql-procedures#doltconflictsresolve).
...
See [`dolt_conflicts_$tablename`](/sql-reference/version-control/dolt-system-tables#doltconflictstablename) for details.
...
[`dolt_commit()` system function](/sql-reference/version-control/dolt-sql-procedures#doltcommit)
or with the [`@@dolt_transaction_commit` system
variable](/sql-reference/version-control/dolt-sysvars#dolttransactioncommit)) if the working
