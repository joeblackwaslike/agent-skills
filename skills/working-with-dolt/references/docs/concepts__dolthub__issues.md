...
source: "https://www.dolthub.com/docs/concepts/dolthub/issues.md"
fetched_at: "2026-06-15T20:08:28.186Z"
sha256: "1491419c240d2dca86b0e117903a64a312874e4df148721d471a18284cedc46a"
---
...
GitHub has some extra features that let's you easily cross-reference issues and [pull requests](/concepts/dolthub/prs). You can link an issue to a pull request and automatically close the issue when a pull request is merged. In GitHub you are also able to assign issues to users and add labels to issues.
...
A contributor noticed some inconsistencies with one of the columns in the `vote_tallies` table. They decided to create an issue to document work that could be done to fix this issue. You can create an issue using the new issue form on any database page.

![](../../.gitbook/assets/new-issue-form.png)

You notice the issue can be easily fixed, so you run a few SQL queries and create a new [pull request](/concepts/dolthub/prs) with some changes.
