...
source: "https://www.dolthub.com/docs/introduction/use-cases/data-and-model-quality.md"
fetched_at: "2026-06-15T20:08:28.186Z"
sha256: "40b3cc8294a28b92ffaa219d2e56364fa1cab1aafa0552f7d5f2e3f30d244f44"
---
...
The version control tools we use to build software apply to modern data science. Version control for data did not exist until Dolt, the first and only database you can [branch](/concepts/dolt/git/branch), [diff](/concepts/dolt/git/diff), and [merge](/concepts/dolt/git/merge) just like a Git repository.

Modern data science applications require model reproducibility, data quality, and multiple versions of data to perform at their best. Dolt allows for these capabilities directly in your database, in a [Git-style version control model](/concepts/dolt/git/) most developers understand.
