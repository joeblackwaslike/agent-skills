...
source: "https://www.dolthub.com/docs/sql-reference/version-control/dolt-sql-procedures.md"
fetched_at: "2026-08-03T07:29:00.623Z"
sha256: "067b2396089cd397c4a35a7c17a99feb1df7087e518f478ef2ce3768e43177e8"
---
...
tables](/sql-reference/version-control/dolt-system-tables) are provided instead.
...
To list branches, use the [`DOLT_BRANCHES` system table](/sql-reference/version-control/dolt-system-tables#dolt_branches), instead of the `DOLT_BRANCH()` stored procedure.

To look up the current branch, use the [`@@<dbname>_head_ref` system variable](/sql-reference/version-control/dolt-sysvars#dbname_head_ref), or the `active_branch()` SQL function, as shown in the examples section below.
...
Branches](/sql-reference/version-control/branches)
...
[`dolt_remotes` system table](/sql-reference/version-control/dolt-system-tables#dolt_remotes).
...
To list existing tags, use [`dolt_tags` system table](/sql-reference/version-control/dolt-system-tables#dolt_tags).
...
[DOLT_CONSTRAINT_VIOLATIONS](/sql-reference/version-control/dolt-system-tables#doltconstraintviolations) table.
