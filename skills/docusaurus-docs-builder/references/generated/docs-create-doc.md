...
sha256: "ec80dbe1545b3e965ca803d7b3f5a82f3c540d226bf517ce71cf20f9523a6cdc"
---
...
- GuidesDocsCreate a docVersion: 3.10.2On this page
# Create a doc
...
Our recommendation for file system organization is: make your file system mirror the sidebar structure (so you don't need to handwrite your `sidebars.js` file), and use the `slug` front matter to customize URLs of each document.Edit this pageLast updated on Jul 10, 2026 by Sébastien Lorber
